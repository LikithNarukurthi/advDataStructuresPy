class Data:
    ...
    def getScore(self):
        return self.score                                            # 221910307033 (Likith Narukurthi)
...
class Scoreboard:
    ...
    def __str__(self):
        return "\n".join(str(self.board[j]) for j in range(self.size))   # 221910307033 (Likith Narukurthi)
...
for i in range(inputs):
    data = Data(int(input("Enter the score: ")))                    # 221910307033 (Likith Narukurthi)
